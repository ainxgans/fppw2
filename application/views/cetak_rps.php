        ...
        <div class="col">
          <table class="table table-bordered text-center">
            <thead>
              <tr>
                <th
                  scope="col"
                  colspan="4"
                  class="border border-dark border-end-0 border-start-0"
                >
            ...
            <tbody>
              ...
              <tr><td class="border-start-0" colspan="4"></td></tr>
              <tr>
      ...
      <table class="table table-bordered text-start">
        <tbody>
          ...
          <tr>
            ...
            <td style="width: 15%;" class=" border-dark border"><?= $matkul['nm_matkul']?> <<?= $matkul['kode']?>></td>
          ...
          <tr>
            ...
            <td style="width: 15%;" class=" border-dark border" rowspan="3"><ul><li>Keaktifan 10%</li><li>Ujian Mid Semester 30 %</li><li>Ujian Akhir Semester 30 %
            </li><li>Tugas 30 %</li></ul></td>
          ...
          <tr>
            ...
            <td class="w-auto border-dark border">< 20</td>
          </tr>
